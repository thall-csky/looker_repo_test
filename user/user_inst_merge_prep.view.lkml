...
view: user_inst_merge_prep {
	sql_table_name: DATAVAULT.USER_INST_MERGE_PREP ;;
	...
	set: all_dims_but_primary {
		fields: [_rsrc, created_at_date, created_at_week, created_at_month, created_at_quarter, created_at_year, link_user_institution_key, hub_user_key, new_record, institution_change, is_institution_change]
	}
