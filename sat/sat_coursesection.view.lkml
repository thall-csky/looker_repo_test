...
view: sat_coursesection {
	...
	dimension: hub_coursesection_key {|		primary_key: yes		type: string
	...
	dimension_group: created_on {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."CREATED_ON" ;;
	}
		

	dimension_group: begin_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."BEGIN_DATE" ;;
	}
		

	dimension_group: end_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."END_DATE" ;;
	}
	...
	dimension_group: grace_period_end_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."GRACE_PERIOD_END_DATE" ;;
	}
		

	dimension_group: grace_period_end_date_override {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
	...
	dimension_group: opt_out_end_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
