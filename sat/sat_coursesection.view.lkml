...
view: sat_coursesection {
	...
	dimension: institution_id_override {
	...
	dimension: course_created_by_guid {
	...
	set: all_dims_but_primary {
		fields: [_ldts, _rsrc, hub_coursesection_key, hash_diff, is_latest_state, rsrc_timestamp, course_key, course_name, created_on, begin_date, end_date, note, institution_id, institution_id_override, deleted, grace_period_end_date, grace_period_end_date_override, course_created_by_guid, is_gateway_course, is_partner_lms, discipline, course_platform, section, course_master, master_context_id, course_cgi, from_course_cgi, timezone, billing_type, iac_isbn, multi_term_isbn13, core_text_isbn13, section_product_type, cu_isbn13, cu_enabled, is_demo, opt_out_enabled, opt_out_days, opt_out_end_date]
	}
