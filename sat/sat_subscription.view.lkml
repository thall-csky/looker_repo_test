...
view: sat_subscription {
	...
	set: all_dims_but_primary {
		fields: [_ldts, _rsrc, link_user_contract_key, hash_diff, rsrc_timestamp, src_environment, src_platform, subscription_state, start_timestamp, end_timestamp, is_latest_state, subscription_id, available_until, plan_id, duration, placed_time, cancelled_time, cancellation_reason, payment_source_type, payment_source_id, payment_source_guid, payment_source_line, item_id]
	}
