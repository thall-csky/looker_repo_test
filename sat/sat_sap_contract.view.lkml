...
view: sat_sap_contract {
	...
	set: all_dims_but_primary {
		fields: [_ldts, _rsrc, link_user_contract_key, hash_diff, is_latest_state, rsrc_timestamp, src_environment, src_platform, original_guid, initialization_time, contract_state]
	}
