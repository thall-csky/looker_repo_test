...
view: sat_user_product_serialnumber {
	...
	dimension: link_user_product_serialnumber_key {|		primary_key: yes		type: string
	...
	dimension_group: registration_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
