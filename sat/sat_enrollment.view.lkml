...
view: sat_enrollment {
	...
	set: all_dims_but_primary {
		fields: [_ldts, _rsrc, link_user_coursesection_key, hash_diff, is_latest_state, rsrc_timestamp, src_platform, src_environment, access_role, self_study_isbn13, enrollment_date, paid_in_full, order_number, payment_code, grace_end_date, transferred, opt_out_institution_purchase, modified_by, access_code_swap, access_code_isbn13, access_code_price, course_isbn_price, billing_type, payment_isbn13, deleted]
	}
