...
view: sat_provisioned_product {
	...
	dimension: link_user_product_key {|		primary_key: yes		type: string
	...
	dimension_group: date_added {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."DATE_ADDED" ;;
	}
		

	dimension_group: expiration_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
	...
	dimension: provisioned_product_row_id {		type: string
	...
	dimension_group: payment_date {|		timeframes: [raw, time, date, week, month, quarter, year]		type: time
		sql: ${TABLE}."PAYMENT_DATE" ;;
	}
		

	dimension: payment_type {		type: string
		sql: ${TABLE}."PAYMENT_TYPE" ;;
	}
		

	dimension: provisioning_type {		type: string
		sql: ${TABLE}."PROVISIONING_TYPE" ;;
	}
		

	dimension: core_text_isbn {		type: string
	...
	dimension: user_environment {		type: string
