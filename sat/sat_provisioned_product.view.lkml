...
view: sat_provisioned_product {
	...
	set: all_dims_but_primary {
		fields: [_ldts, _rsrc, link_user_product_key, hash_diff, is_latest_state, rsrc_timestamp, src_environment, src_platform, date_added, expiration_date, context_id, source, source_id, code_type, deleted, order_number, provisioned_product_row_id, modified_by, payment_date, payment_type, provisioning_type, core_text_isbn, iac_isbn, user_type, user_environment, institution_id, region]
	}
