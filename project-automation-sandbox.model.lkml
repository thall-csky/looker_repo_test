...
explore: hub_book {
	...
	join: link_book_isbn {
		...
		sql_on: ${link_book_isbn.hub_book_key} = ${hub_book.hub_book_key} ;;
		fields: []
	}
	...
	join: link_user_book {
		from: link_user_book
		relationship: one_to_many
		sql_on: ${link_user_book.hub_book_key} = ${hub_book.hub_book_key} ;;
		fields: []
	}
	...
	join: sat_reader_event {
		...
		relationship: one_to_many
		required_joins: [link_user_book]
		sql_on: ${sat_reader_event.link_user_book_key} = ${link_user_book.link_user_book_key} ;;
	}
	...
	join: link_user_coursesection {
		...
		sql_on: ${link_user_coursesection.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_contract_subscription {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_contract_subscription.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_subscription {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_subscription.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: sat_user_pii {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${sat_user_pii.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: link_product_isbn {
		...
		sql_on: ${link_product_isbn.hub_isbn_key} = ${hub_isbn.hub_isbn_key} ;;
		fields: []
	}
	...
	join: link_user_product_serialnumber {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_product_serialnumber.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: sat_user_login {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${sat_user_login.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: link_user_product_contract {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_product_contract.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: sat_user_marketing {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${sat_user_marketing.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: link_coursesection_isbn {
		...
		relationship: one_to_many
		required_joins: [link_book_isbn, hub_isbn]
		sql_on: ${link_coursesection_isbn.hub_isbn_key} = ${hub_isbn.hub_isbn_key} ;;
		fields: []
	}
	...
	join: sat_user {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${sat_user.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: link_user_platform {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_platform.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_order {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_order.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_subscription_product {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_subscription_product.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_institution {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_institution.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: sat_user_internal {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${sat_user_internal.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: pit_user {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${pit_user.hub_user_key} = ${hub_user.hub_user_key} ;;
	}
	...
	join: link_user_contract {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_contract.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_product {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user]
		sql_on: ${link_user_product.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: sat_user_institution {
		...
		sql_on: ${sat_user_institution.link_user_institution_key} = ${link_user_institution.link_user_institution_key} ;;
	}
	...
	join: sat_provisioned_product {
		...
		sql_on: ${sat_provisioned_product.link_user_product_key} = ${link_user_product.link_user_product_key} ;;
	}
	...
	join: sat_sap_contract {
		...
		sql_on: ${sat_sap_contract.link_user_contract_key} = ${link_user_contract.link_user_contract_key} ;;
	}
	...
	join: sat_subscription {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_contract]
		sql_on: ${sat_subscription.link_user_contract_key} = ${link_user_contract.link_user_contract_key} ;;
	}
	...
	join: sat_common_event {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_platform]
		sql_on: ${sat_common_event.link_user_platform_key} = ${link_user_platform.link_user_platform_key} ;;
	}
	...
	join: sat_sap_subscription {
		...
		sql_on: ${sat_sap_subscription.link_user_contract_subscription_key} = ${link_user_contract_subscription.link_user_contract_subscription_key} ;;
	}
	...
	join: sat_enrollment {
		...
		sql_on: ${sat_enrollment.link_user_coursesection_key} = ${link_user_coursesection.link_user_coursesection_key} ;;
	}
	...
	join: sat_user_product_serialnumber {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_product_serialnumber]
		sql_on: ${sat_user_product_serialnumber.link_user_product_serialnumber_key} = ${link_user_product_serialnumber.link_user_product_serialnumber_key} ;;
	}
	...
	join: sat_order {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_contract]
		sql_on: ${sat_order.link_user_contract_key} = ${link_user_contract.link_user_contract_key} ;;
	}
	...
	join: sat_user_contract {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_contract]
		sql_on: ${sat_user_contract.link_user_contract_key} = ${link_user_contract.link_user_contract_key} ;;
	}
	...
	join: sat_sap_order {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_order]
		sql_on: ${sat_sap_order.link_user_order_key} = ${link_user_order.link_user_order_key} ;;
	}
	...
	join: link_coursesection_institution {
		...
		sql_on: ${link_coursesection_institution.hub_institution_key} = ${hub_institution.hub_institution_key} ;;
		fields: []
	}
	...
	join: sat_product {
		...
		sql_on: ${sat_product.hub_product_key} = ${hub_product.hub_product_key} ;;
	}
	...
	join: link_subscription_order {
		...
		sql_on: ${link_subscription_order.hub_order_key} = ${hub_order.hub_order_key} ;;
		fields: []
	}
	...
	join: sat_coursesection {
		...
		sql_on: ${sat_coursesection.hub_coursesection_key} = ${hub_coursesection.hub_coursesection_key} ;;
	}
	...
	join: sat_serialnumber {
		...
		sql_on: ${sat_serialnumber.hub_serialnumber_key} = ${hub_serialnumber.hub_serialnumber_key} ;;
	}
	...
	join: sat_product_attr {
		...
		relationship: one_to_many
		required_joins: [link_user_book, hub_user, link_user_product_contract, hub_product]
		sql_on: ${sat_product_attr.hub_product_key} = ${hub_product.hub_product_key} ;;
	}
	...
	join: sat_product_relationship {
		...
		sql_on: ${sat_product_relationship.link_product_relationship_key} = ${link_product_relationship.link_product_relationship_key} ;;
	}
...
explore: hub_contract {
	...
	join: link_user_contract_subscription {
		from: link_user_contract_subscription
		relationship: one_to_many
		sql_on: ${link_user_contract_subscription.hub_contract_key} = ${hub_contract.hub_contract_key} ;;
		fields: []
	}
	...
	join: link_user_product_contract {
		from: link_user_product_contract
		relationship: one_to_many
		sql_on: ${link_user_product_contract.hub_contract_key} = ${hub_contract.hub_contract_key} ;;
		fields: []
	}
	...
	join: link_user_contract {
		from: link_user_contract
		relationship: one_to_many
		sql_on: ${link_user_contract.hub_contract_key} = ${hub_contract.hub_contract_key} ;;
		fields: []
	}
	...
	join: link_subscription_order {
		...
		sql_on: ${link_subscription_order.hub_subscription_key} = ${hub_subscription.hub_subscription_key} ;;
		fields: []
	}
	...
	join: link_user_subscription {
		...
		relationship: one_to_many
		required_joins: [link_user_contract_subscription, hub_subscription]
		sql_on: ${link_user_subscription.hub_subscription_key} = ${hub_subscription.hub_subscription_key} ;;
		fields: []
	}
	...
	join: link_product_isbn {
		...
		relationship: one_to_many
		required_joins: [link_user_product_contract, hub_product]
		sql_on: ${link_product_isbn.hub_product_key} = ${hub_product.hub_product_key} ;;
		fields: []
	}
	...
	join: link_user_product_serialnumber {
		...
		relationship: one_to_many
		required_joins: [link_user_product_contract, hub_product]
		sql_on: ${link_user_product_serialnumber.hub_product_key} = ${hub_product.hub_product_key} ;;
		fields: []
	}
	...
	join: link_user_subscription_product {
		...
		relationship: one_to_many
		required_joins: [link_user_product_contract, hub_product]
		sql_on: ${link_user_subscription_product.hub_product_key} = ${hub_product.hub_product_key} ;;
		fields: []
	}
	...
	join: link_user_book {
		...
		relationship: one_to_many
		required_joins: [link_user_contract_subscription, hub_user]
		sql_on: ${link_user_book.hub_user_key} = ${hub_user.hub_user_key} ;;
		fields: []
	}
	...
	join: link_user_product {
		...
		relationship: one_to_many
		required_joins: [link_user_product_contract, hub_product]
		sql_on: ${link_user_product.hub_product_key} = ${hub_product.hub_product_key} ;;
		fields: []
	}
	...
	join: link_book_isbn {
		...
		sql_on: ${link_book_isbn.hub_isbn_key} = ${hub_isbn.hub_isbn_key} ;;
		fields: []
	}
...
explore: hub_coursesection {
	...
	join: link_user_coursesection {
		from: link_user_coursesection
		relationship: one_to_many
		sql_on: ${link_user_coursesection.hub_coursesection_key} = ${hub_coursesection.hub_coursesection_key} ;;
		fields: []
	}
	...
	join: link_coursesection_institution {
		from: link_coursesection_institution
		relationship: one_to_many
		sql_on: ${link_coursesection_institution.hub_coursesection_key} = ${hub_coursesection.hub_coursesection_key} ;;
		fields: []
	}
	...
	join: link_coursesection_isbn {
		from: link_coursesection_isbn
		relationship: one_to_many
		sql_on: ${link_coursesection_isbn.hub_coursesection_key} = ${hub_coursesection.hub_coursesection_key} ;;
		fields: []
	}
...
explore: hub_institution {
	...
	join: link_user_institution {
		from: link_user_institution
		relationship: one_to_many
		sql_on: ${link_user_institution.hub_institution_key} = ${hub_institution.hub_institution_key} ;;
		fields: []
	}
...
explore: hub_isbn {
	...
	join: link_user_product_contract {
		...
		relationship: one_to_many
		required_joins: [link_product_isbn, hub_product]
		sql_on: ${link_user_product_contract.hub_product_key} = ${hub_product.hub_product_key} ;;
		fields: []
	}
...
explore: hub_order {
	...
	join: link_user_order {
		from: link_user_order
		relationship: one_to_many
		sql_on: ${link_user_order.hub_order_key} = ${hub_order.hub_order_key} ;;
		fields: []
	}
	...
	join: link_user_contract_subscription {
		...
		sql_on: ${link_user_contract_subscription.hub_subscription_key} = ${hub_subscription.hub_subscription_key} ;;
		fields: []
	}
	...
	join: link_user_subscription_product {
		...
		relationship: one_to_many
		required_joins: [link_subscription_order, hub_subscription]
		sql_on: ${link_user_subscription_product.hub_subscription_key} = ${hub_subscription.hub_subscription_key} ;;
		fields: []
	}
...
explore: hub_platform {
	...
	join: link_user_platform {
		from: link_user_platform
		relationship: one_to_many
		sql_on: ${link_user_platform.hub_platform_key} = ${hub_platform.hub_platform_key} ;;
		fields: []
	}
...
explore: hub_serialnumber {
	...
	join: link_user_product_serialnumber {
		from: link_user_product_serialnumber
		relationship: one_to_many
		sql_on: ${link_user_product_serialnumber.hub_serialnumber_key} = ${hub_serialnumber.hub_serialnumber_key} ;;
		fields: []
	}
